...
func Cors() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// header的类型
		c.Header("Access-Control-Allow-Headers", "Sec-CH-UA, Sec-CH-UA-Mobile, Sec-CH-UA-Platform, Referer, Content-Type, Authorization, Content-Length, X-CSRF-Token, Token,session,X_Requested_With,Accept, Origin, Host, Connection, Accept-Encoding, Accept-Language,DNT, X-CustomHeader, Keep-Alive, User-Agent, X-Requested-With, If-Modified-Since, Cache-Control, Content-ResourceType, Pragma, accessToken, X-AppId, X-Signature, X-Signature-Method")
		// 允许跨域设置	 可以返回其他子段
		// 跨域关键设置 让浏览器可以解析
